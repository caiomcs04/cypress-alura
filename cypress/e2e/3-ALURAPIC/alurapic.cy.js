describe('Login e registro de usuarios alura pic',()=>{
    ...
    it('Verificar mensagem "Maximun length is 40" for full name', ()=>{
        cy.contains('a', 'Register now').click();
        cy.get('input[formcontrolname="fullName"]').type('12345678901234567891123456789212345678931234567894')
        cy.contains('button', 'Register').click();
    ...
    it('Verificar mensagem "Maximun length is 30" for user name', ()=>{
        cy.contains('a', 'Register now').click();
        cy.get('input[formcontrolname="userName"]').type('1234567890123456789112345678921234567893')
        cy.contains('button', 'Register').click();
